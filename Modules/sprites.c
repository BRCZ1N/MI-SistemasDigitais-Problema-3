...
int spriteTest(){
	...
	while(1){ if(isFull() == 0) { setSprite(sprt_6.data_register, sprt_6.coord_x, sprt_6.coord_y, sprt_6.offset, sprt_6.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_7.data_register, sprt_7.coord_x, sprt_7.coord_y, sprt_7.offset, sprt_7.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_8.data_register, sprt_8.coord_x, sprt_8.coord_y, sprt_8.offset, sprt_8.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_9.data_register, sprt_9.coord_x, sprt_9.coord_y, sprt_9.offset, sprt_9.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_10.data_register, sprt_10.coord_x, sprt_10.coord_y, sprt_10.offset, sprt_10.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_11.data_register, sprt_11.coord_x, sprt_11.coord_y, sprt_11.offset, sprt_11.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_12.data_register, sprt_12.coord_x, sprt_12.coord_y, sprt_12.offset, sprt_12.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_13.data_register, sprt_13.coord_x, sprt_13.coord_y, sprt_13.offset, sprt_13.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_14.data_register, sprt_14.coord_x, sprt_14.coord_y, sprt_14.offset, sprt_14.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_15.data_register, sprt_15.coord_x, sprt_15.coord_y, sprt_15.offset, sprt_15.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_16.data_register, sprt_16.coord_x, sprt_16.coord_y, sprt_16.offset, sprt_16.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_17.data_register, sprt_17.coord_x, sprt_17.coord_y, sprt_17.offset, sprt_17.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_18.data_register, sprt_18.coord_x, sprt_18.coord_y, sprt_18.offset, sprt_18.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_19.data_register, sprt_19.coord_x, sprt_19.coord_y, sprt_19.offset, sprt_19.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_20.data_register, sprt_20.coord_x, sprt_20.coord_y, sprt_20.offset, sprt_20.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_21.data_register, sprt_21.coord_x, sprt_21.coord_y, sprt_21.offset, sprt_21.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_22.data_register, sprt_22.coord_x, sprt_22.coord_y, sprt_22.offset, sprt_22.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_23.data_register, sprt_23.coord_x, sprt_23.coord_y, sprt_23.offset, sprt_23.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_24.data_register, sprt_24.coord_x, sprt_24.coord_y, sprt_24.offset, sprt_24.ativo); break; } }
	while(1){ if(isFull() == 0) { setSprite(sprt_25.data_register, sprt_25.coord_x, sprt_25.coord_y, sprt_25.offset, sprt_25.ativo); break; } }
